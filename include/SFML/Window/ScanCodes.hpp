...
namespace ENUS
{
    ...
    static const ScanCode International1 = 112; ///< The International 1 key: this is generally not included on ENUS layouts
    static const ScanCode International2 = 113; ///< The International 2 key: this is generally not included on ENUS layouts
